...
async function getCaptcha() {
  return axios({
    method: "get",
    url:
      "http://doctorabbasi.ir/application/views/create_image.php?0.8053264878919875",
    headers: {
      accept:
...
async function main() {
  ...
  data.captcha = await askQuestion(
    "A new captcha.jpg is saved at ./dist/captcha.jpg, Please enter it's number: "
  );
